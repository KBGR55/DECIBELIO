...
class AnimatedMapControllerPageState extends State<AnimatedMapControllerPage>
  ...
  static SvgPicture mark = SvgPicture.asset(
  'assets/icons/map-marker-svgrepo-com.svg', // Ruta del archivo SVG
  width: 50, // Ajustar el tamaño del SVG
  height: 50,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: AnimatedIcon(icon: AnimatedIcons.menu_home, progress: ProxyAnimation()),
      body: Padding(
