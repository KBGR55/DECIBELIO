...
class Observation {
  ...
  final String
      time; // Debería ser LocalTime en Java, pero se puede usar String aquí
  ...
  @override
  String toString() {
    return 'Observation(id: $id, date: $date, time: $time, value: $value, geoLocation: $geoLocation, range: $range, sensorExternalId: $sensorExternalId)';
  }
}
