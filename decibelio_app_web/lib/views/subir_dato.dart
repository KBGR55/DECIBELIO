        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  if (_fileName == null)
                    Column(
                      ...
                      children: [
                        Icon(Icons.cloud_upload, size: 50, color: Colors.black38),
                        SizedBox(height: 10),
                        Text("Arrastra y suelta archivos aquí", style: TextStyle(color: Colors.black38)),
                        Text("o", style: TextStyle(color: Colors.black38)),
                        SizedBox(height: 10),
                        ElevatedButton(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(_fileName!, style: TextStyle(color: Colors.blue)),
                        SizedBox(height: 10),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
            ...
            ElevatedButton(
              ...
              child: Text("Subir"),
              onPressed: _file != null && !_isUploading ? () => _showConfirmationDialog(context) : null,
            ),
          ],
        ),
      ),
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null) {
      ...
      if (bytes != null) {
        setState(() {
          _fileName = name;
          _file = html.File([bytes], name, {'type': 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'});
        });
      } else {
      ...
      if (mounted) {
        setState(() {
          ...
          if (respuesta.status == 'SUCCESS') {
            ...
            _payload = respuesta.payload; // Almacenar el payload en caso de error
          }
        });
      }
    } catch (e) {
